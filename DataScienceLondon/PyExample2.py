...
# Read data
train = np.genfromtxt(open(workDir + 'train-2.csv','rb'), delimiter=',')
target = np.genfromtxt(open(workDir + 'trainLabels-2.csv','rb'), delimiter=',')
test = np.genfromtxt(open(workDir + 'test-2.csv','rb'), delimiter=',')
