...
# Source: https://github.com/dmcgarry/Data_Science_London_scilearn
...
#load data
train <- read.csv(file="train.csv",header=F)  # This is a MERGED File of train.csv and trainLabels.csv
                                              # trainLabels values are in the 1st column of the file
